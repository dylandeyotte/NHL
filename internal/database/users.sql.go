...
SELECT id, users.created_at, users.updated_at, email, hashed_password, token, refresh_token.created_at, refresh_token.updated_at, user_id, expires_at, revoked_at FROM users
